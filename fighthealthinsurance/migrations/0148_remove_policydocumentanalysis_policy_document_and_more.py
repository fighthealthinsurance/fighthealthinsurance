...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("fighthealthinsurance", "0147_merge_20260104_2342"),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="extralinkfetchlog",
            index=models.Index(
                fields=["document", "timestamp"], name="fighthealth_documen_680b7f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="extralinkfetchlog",
            index=models.Index(
                fields=["status", "timestamp"], name="fighthealth_status_b96312_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="micrositeextralink",
            index=models.Index(
