# Generated by Django 5.2.9 on 2026-05-02 23:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameIndex(
            model_name="cmscoveragecache",
            new_name="fighthealth_procedu_3ccc23_idx",
            old_name="cms_cov_proc_diag_idx",
        ),
        migrations.AddIndex(
            model_name="ecriguideline",
            index=models.Index(
                fields=["source", "is_active"], name="fighthealth_source_012590_idx"
            ),
        ),
    ]
