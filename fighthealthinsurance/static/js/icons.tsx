...
// Simple paperclip icon similar to @tabler/icons-react IconPaperclip
export function IconPaperclip({ size = 24, ...props }: IconProps) {
  return (
    <svg
...
// Simple send icon similar to @tabler/icons-react IconSend
