...
GLOSSARY_TERMS: tuple[GlossaryTerm, ...] = (
    ...
    GlossaryTerm(
        ...
        definition=(
            ...
            "65 days. Medicaid managed care gives you 60 calendar days from the "
            "date on the notice (42 CFR 438.402(c)(2)(ii)); to keep benefits "
            "going while you appeal you have to act sooner. Always check the "
            "deadline "
